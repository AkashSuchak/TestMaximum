...
namespace FindMaximumNumber
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Maximum Number At First, Second and Third Place 
            string outputString1 = maximumNumberCheck.MaximumNumber<string>("banana", "peach", "apple");
            string outputString2 = maximumNumberCheck.MaximumNumber<string>("apple", "banana", "peach");
            string outputString3 = maximumNumberCheck.MaximumNumber<string>("apple", "peach", "banana");
